...
syms x6 y6 z6; 
% jacobienne en position coordonnees point fixe de R6 dans R0 
% employer la fonction jacobian de matlab 
q = [q1;q2;q3;q4;q5;q6];
P6 = [x6;y6;z6]
P06 = T06(1:3,:)*[P6;1] % coordonnees du point P du repere 6 dans le repere 0
J0P6 = jacobian(P06,q)
matlabFunction(J0P6,'File','J0P6Ned2.m','vars',{q;params;P6});
J0U6 = sym(zeros(3,nq)); 
R06 = T06(1:3,1:3);
R60 = inv(R06); 
% jacobienne en orientation d R6/R0
% pour chqaue qk, calculer D0R6/Dqk.6RO 
% en deduire la colonne correspondante de la jacobianne en orientation
for k = 1:nq
    qk = q(k); 
    D0R6 = diff(R06,qk)
    M = D0R6*R60; 
    % on reccupere mqintenant les composantes de la matrice colonne voulu
    J0U6(:,k) = [M(1,3);M(2,1);M(3,2)]
end 
J0U6 = simplify(J0U6);  
