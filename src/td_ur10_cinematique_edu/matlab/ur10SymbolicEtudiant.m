...
func_MGD=matlabFunction(T01,T12,T23,T34,T45,T56,'File','MGD_ur10','Vars',[q1;q2;q3;q4;q5;q6;d1;a2;a3;d4;d5;d6]);
% a completer : calcul de T02 a T06 et inverses (utiliser eventuellement la fonction simplify )
T02=a_completer;T20=simplify(get_InvT(T02));
T03=a_completer;T30=simplify(get_InvT(T03));
T04=a_completer;T40=simplify(get_InvT(T04));
T05=a_completer;T50=simplify(get_InvT(T05));
T06=a_completer;T60=simplify(get_InvT(T06));
